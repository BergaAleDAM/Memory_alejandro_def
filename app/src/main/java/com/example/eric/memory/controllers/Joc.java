...
public class Joc extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int[] param = dimensionesAImageAdapter();
        adapter = new ImageAdapter(this, partida,param[0],param[1]);
    ...
    private int[] dimensionesAImageAdapter() {
        DisplayMetrics displayMetrics = new DisplayMetrics();
        getWindowManager().getDefaultDisplay().getMetrics(displayMetrics);


         int[] parametros = {displayMetrics.widthPixels, displayMetrics.heightPixels};
